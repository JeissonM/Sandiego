...
<div class="row-one">
    <h3 class="title1" style="color: #287094 !important;">Editar Tipo de Caso</h3>
    <div class="well">
    ...
    <div class="form-grids row widget-shadow" data-example-id="basic-forms">
        ...
        <div class="form-body">
            <form class="form" role='form' method="POST" action="{{route('tipocaso.update',$tipocaso->id)}}">
                @csrf
                <input name="_method" type="hidden" value="PUT" />
                <div class="form-group">
                    <div class="col-md-6">
                        <label for="exampleInputEmail1">Descripción del Tipo de Caso*</label>
                        <input class="form-control" value="{{$tipocaso->descripcion}}" type="text" required="required" name="descripcion">
                    </div>
                    <div class="col-md-6">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="alert alert-default" role="alert" style="text-align: justify;">
                        <p>Edite los datos de los Tipos de Casos.</p>
                    </div>
                </div>
            </div>
