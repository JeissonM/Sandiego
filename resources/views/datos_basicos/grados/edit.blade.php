...
<div class="row-one">
    <h3 class="title1" style="color: #287094 !important;">Editar Grado</h3>
    <div class="well">
    ...
    <div class="form-grids row widget-shadow" data-example-id="basic-forms">
        ...
        <div class="form-body">
            <form class="form" role='form' method="POST" action="{{route('grado.update',$grado->id)}}">
                @csrf
                <input name="_method" type="hidden" value="PUT" />
                <div class="form-group">
                    <div class="col-md-12">
                        <label for="exampleInputEmail1">Nombre del Grado*</label>
                        <input class="form-control" value="{{$grado->grado}}" type="text" required="required" name="grado">
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="alert alert-default" role="alert" style="text-align: justify;">
                        <p>Edite los datos de los Grados, los Grados indican los los niveles educativos que oferta la institución</p>
                    </div>
                </div>
            </div>
