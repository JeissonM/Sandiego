...
<div class="row-one">
    <h3 class="title1" style="color: #ea4c89 !important;">Crear Persona</h3>
    <div class="well">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="alert alert-default" role="alert" style="text-align: justify;">
                        <p>Agregue nuevas Personas, las personas naturales son los estudiantes, entes rectores, docentes, padres de familia, entre otros de la institución.</p>
                    </div>
                </div>
            </div>
