...
<div class="row-one">
    <h3 class="title1" style="color: #ea4c89 !important;">Crear Ente</h3>
    <div class="well">
    ...
    <div class="form-grids row widget-shadow" data-example-id="basic-forms">
        ...
        <div class="form-body">
            <form class="form" role='form' method="POST" action="{{route('entecontrol.store')}}">
                @csrf
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="col-md-3">
                            ...
                            <input class="form-control" type="text" required="required" name="razonsocial">
                        </div>
                        <div class="col-md-3">
                            <label>Número Resolución</label>
                            <input class="form-control" type="text" name="numeroresolucion">
                        </div>
                        <div class="col-md-3">
                            <label>Representante Legal*</label>
                            <input class="form-control" type="text" required="required" name="representantelegal">
                        </div>
                        <div class="col-md-3">
                            <label>Cargo Representante</label>
                            <input class="form-control" type="text" name="cargorepresentante">
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="alert alert-default" role="alert" style="text-align: justify;">
                        <p>Agregue nuevos entes, los Entes de Control son los hospitales, secreatarías de salud, bomberos, policía, etc.</p>
                    </div>
                </div>
            </div>
