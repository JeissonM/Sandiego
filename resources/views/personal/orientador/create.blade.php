...
<li><a href="{{ route('orientador.index') }}">Orientadores</a></li>
...
<div class="row-one">
    <h3 class="title1" style="color: #ea4c89 !important;">Crear Orientador</h3>
    <div class="well">
        <a href="{{route('orientador.index')}}" class="btn btn-personal"><i class="fa fa-reply-o"></i> Volver</a>
        <a class="btn btn-default" data-toggle="modal" data-target="#gridSystemModal"><i class="fa fa-question"></i> Ayuda</a>
    </div>
    <div class="form-grids row widget-shadow" data-example-id="basic-forms">
        <div class="form-title">
            <h4>Datos del Orientador</h4>
        </div>
        <div class="form-body">
            <form class="form" role='form' method="POST" action="{{route('orientador.store')}}">
                @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="alert alert-default" role="alert" style="text-align: justify;">
                        <p>Agregue nuevos Orientadores.</p>
                    </div>
                </div>
            </div>
