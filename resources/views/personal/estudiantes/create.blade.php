...
<div class="row-one">
    <h3 class="title1" style="color: #ea4c89 !important;">Crear Docente</h3>
    <div class="well">
        <a href="{{route('docente.index')}}" class="btn btn-personal"><i class="fa fa-reply-o"></i> Volver</a>
