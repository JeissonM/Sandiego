...
<div class="row-one">
    <h3 class="title1" style="color: red !important;">Crear Grupo</h3>
    <div class="well">
    ...
    <div class="form-grids row widget-shadow" data-example-id="basic-forms">
        ...
        <div class="form-body">
            <form class="form" role='form' method="POST" action="{{route('grupousuario.store')}}">
                @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="alert alert-default" role="alert" style="text-align: justify;">
                        <p>Agregue nuevos grupos, los grupos de usuarios son los roles o agrupaciones de usuarios que permite asignarle privilegios a todo un conglomerado de usuarios que comparte funciones. Ejemplo de grupos de usuarios: ADMINISTRADORES, ESTUDIANTES, BIENESTAR, SISTEMAS, DOCENTES, ETC.</p>
                    </div>
                </div>
            </div>
